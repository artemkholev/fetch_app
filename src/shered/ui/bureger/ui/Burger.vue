<template>
  <div
    ...
    @click.prevent="changeSidebarPanel"
  >
    <slot>
      <button type="button" class="burger-button" title="Menu">
        <span class="hidden">Toggle menu</span>
        <span
          class="burger-bar burger-bar--1"
          :style="{ backgroundColor: isDarkStyle }"
        ></span>
        <span
          class="burger-bar burger-bar--2"
          :style="{ backgroundColor: isDarkStyle }"
        ></span>
        <span
          class="burger-bar burger-bar--3"
          :style="{ backgroundColor: isDarkStyle }"
        ></span>
      </button>
    </slot>
